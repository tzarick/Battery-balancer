...
static can_bim_mailbox_t mailboxes[BIM_MAILBOXES] =
{
	...
	CAN_BIM_MAILBOX_INIT(CELLS_41_TO_44_ID, CELLS_45_TO_46_ID, 41, 42, 43, 44),
	CAN_BIM_MAILBOX_INIT(CELLS_47_TO_50_ID, CELLS_51_TO_54_ID, 49, 50, 51, 52),
	CAN_BIM_MAILBOX_INIT(CELLS_55_TO_58_ID, CELLS_59_TO_62_ID, 57, 58, 59, 60),
	CAN_BIM_MAILBOX_INIT(CELLS_63_TO_66_ID, CELLS_67_TO_70_ID, 65, 66, 67, 68),
	CAN_BIM_MAILBOX_INIT(CELLS_71_TO_74_ID, CELLS_75_TO_78_ID, 73, 74, 75, 76),
	CAN_BIM_MAILBOX_INIT(CELLS_79_TO_82_ID, CELLS_83_TO_86_ID, 81, 82, 83, 84),
	CAN_BIM_MAILBOX_INIT(CELLS_87_TO_90_ID, CELLS_91_TO_94_ID, 89, 90, 91, 92),
	CAN_BIM_MAILBOX_INIT(CELLS_95_TO_98_ID, CELLS_99_TO_102_ID, 97, 98, 99, 100),
	CAN_BIM_MAILBOX_INIT(CELLS_103_TO_106_ID, CELLS_107_TO_110_ID, 105, 106, 107, 108),
	CAN_BIM_MAILBOX_INIT(CELLS_111_TO_114_ID, CELLS_115_TO_118_ID, 113, 114, 115, 116),
	CAN_BIM_MAILBOX_INIT(CELLS_119_TO_122_ID, CELLS_123_TO_126_ID, 121, 122, 123, 124),
	CAN_BIM_MAILBOX_INIT(CELLS_127_TO_130_ID, CELLS_131_TO_134_ID, 129, 130, 131, 132)
};
